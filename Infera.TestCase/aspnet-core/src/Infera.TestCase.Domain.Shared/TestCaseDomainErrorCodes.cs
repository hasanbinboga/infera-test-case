...
public static class TestCaseDomainErrorCodes
{
    ...
    public const string WarehouseAlreadyExists = "Infera.TestCase:00006";
    public const string AccountingInvoiceAlreadyExists = "Infera.TestCase:00007";
}
